...
> From application programming interface to application binary interface

Interestingly, this is the point where compilers and operating system kernels connect.

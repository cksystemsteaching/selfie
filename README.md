...
We could actually continue doing this but because of the fixed-point nothing would change anymore except that things get very slow:

```bash
./selfie -c selfie.c -m 2 -c selfie.c -m 1 -c selfie.c
```

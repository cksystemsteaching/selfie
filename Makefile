...
test: selfie
	...
	./selfie -c selfie.c -o selfie.r -m 1 -l selfie.r -m 1
	./selfie -c selfie.c -o selfie3.r -s selfie3.s -y 2 -l selfie3.r -y 2 -l selfie3.r -y 2 -c selfie.c -o selfie4.r -s selfie4.s
	diff -q selfie3.r selfie4.r
	diff -q selfie3.s selfie4.s
	diff -q selfie1.r selfie3.r
	diff -q selfie1.s selfie3.s
	./selfie -c selfie.c -o selfie5.r -s selfie5.s -min 3 -l selfie5.r -y 2 -l selfie5.r -y 2 -c selfie.c -o selfie6.r -s selfie6.s

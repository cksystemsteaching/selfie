...
spike: selfie.m selfie.s
	spike pk selfie.m -c selfie.c -o selfie8.m -s selfie8.s -m 1
...
qemu: selfie.m selfie.s
	chmod +x selfie.m
	qemu-riscv64-static selfie.m -c selfie.c -o selfie9.m -s selfie9.s -m 1
	diff -q selfie.m selfie9.m
	diff -q selfie.s selfie9.s

x86: selfie-2-x86 selfie.m selfie.s selfie.h
	chmod +x selfie.x86
	./selfie.x86 -c selfie.c -o selfie10.m -s selfie10.s
	diff -q selfie.m selfie10.m
	diff -q selfie.s selfie10.s
	./selfie.x86 -c selfie.h tools/riscv-2-x86.c -m 1 -l selfie10.m
	diff -q selfie.x86 selfie10.x86

...
# Consider these targets as targets, not files
.PHONY: grader grade spike qemu assemble 32-bit x86 boolector btormc validator extras

# Run everything that requires non-standard tools
extras: grader grade spike qemu assemble 32-bit x86 boolector btormc validator

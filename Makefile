...
# Consider these targets as targets, not files
.PHONY: grader grade assemble spike qemu 32-bit x86 boolector btormc validator extras

# Run everything that requires non-standard tools
extras: grader grade assemble spike qemu 32-bit x86 boolector btormc validator
...
32-bit: selfie-32-bit
	...
	riscv64-linux-gnu-as selfie1-32-bit.s
...
# Run selfie natively as x86 binary generated by RISC-V-to-x86 translator

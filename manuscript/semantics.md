...
In other words, for a computer `selfie.c` is in fact a sequence of eight times 284,556 bits, that is, 2,276,448 bits. The key question addressed by this book is where the meaning of these bits comes from.

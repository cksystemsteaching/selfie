...
[computer architecture]: http://en.wikipedia.org/wiki/Computer_architecture "Computer Architecture"
...
[scope]: http://en.wikipedia.org/wiki/Declaration_(computer_programming) "Scope"
[subroutine]: http://en.wikipedia.org/wiki/Subroutine "Subroutine"
[local variable]: http://en.wikipedia.org/wiki/Local_variable "Local Variable"

[imperative]: http://en.wikipedia.org/wiki/Imperative_programming "Imperative Programming"
[statement]: http://en.wikipedia.org/wiki/Statement_(computer_science) "Statement"
[declarative]: http://en.wikipedia.org/wiki/Declarative_programming "Declarative Programming"
[assignment]: http://en.wikipedia.org/wiki/Assignment_(computer_science) "Assignment"
[expression]: http://en.wikipedia.org/wiki/Expression_(computer_science) "Expression"

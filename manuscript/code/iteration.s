...
0x10(~1): 0x01090019: multu $t0,$t1        // $gp=632[0x278] which is the
0x14(~1): 0x00004012: mflo $t0             // program break, the first
0x18(~1): 0x00000000: nop                  // address after code, strings,
0x1C(~1): 0x00000000: nop                  // and global variables;
...
........: nop instructions removed         // of the top of the stack;
0x40(~1): 0x0C000067: jal 0x67[0x19C]      // link 0x48 in $ra for returning
0x44(~1): 0x00000000: nop                  // and jump to 0x19C.
-------------------------------------------------------------------------------

...
char*    model_name = 0; // name of model file
...
void model_syscalls() {
  ...
  printf("%lu and 1 %lu %lu ; ecall is active for invalid syscall id\n",
  ...
  printf("%lu bad %lu ; ecall invalid syscall id\n\n",
  ...
  printf("%lu ite 1 60 %lu %lu ; stay in kernel mode indefinitely if exit ecall is active\n\n",
  ...
  // read ecall
  printf("%lu and 1 %lu %lu ; read ecall is active\n",
    (current_nid + 1100), // nid of this line
    ecall_flow_nid,       // nid of most recent update of ecall activation
    (current_nid + 11));  // nid of $a7 == SYSCALL_READ

  // if read ecall is active record $a1 register for checking address validity
  printf("%lu ite 2 %lu %lu %lu ; $a1 is start address of write buffer for checking address validity\n",
  ...
  printf("%lu ite 1 %lu 11 %lu ; go into kernel mode if read ecall is active\n",
  ...
  printf("%lu ite 2 %lu 20 %lu ; set $a0 = 0 bytes if read ecall is active\n",
  ...
  *(reg_flow_nids + REG_A0) = current_nid + 1151;
  ...
  printf("%lu sub 2 %lu %lu ; $a2 - $a0\n",
    (current_nid + 1160), // nid of this line
    (reg_nids + REG_A2),  // nid of current value of $a2 register
    (reg_nids + REG_A0)); // nid of current value of $a0 register
  printf("%lu ugte 1 %lu 28 ; $a2 - $a0 >= 8 bytes\n",
    (current_nid + 1161),  // nid of this line
    (current_nid + 1160)); // nid of $a2 - $a0
  printf("%lu ite 2 %lu 28 %lu ; read 8 bytes if $a2 - $a0 >= 8 bytes, or else $a2 - $a0 bytes\n",
    (current_nid + 1162),  // nid of this line
    (current_nid + 1161),  // nid of $a2 - $a0 >= 8 bytes
    (current_nid + 1160)); // nid of $a2 - $a0

  // compute unsigned-extended input
  printf("%lu eq 1 %lu 22 ; increment == 2\n",
    (current_nid + 1170),  // nid of this line
    (current_nid + 1162)); // nid of increment
  printf("%lu ite 2 %lu 92 91 ; unsigned-extended 2-byte input if increment == 2, or else unsigned-extended 1-byte input\n",
    (current_nid + 1171),  // nid of this line
    (current_nid + 1170)); // nid of increment == 2
  printf("%lu eq 1 %lu 23 ; increment == 3\n",
    (current_nid + 1172),  // nid of this line
    (current_nid + 1162)); // nid of increment
  printf("%lu ite 2 %lu 93 %lu ; unsigned-extended 3-byte input if increment == 3\n",
  ...
  printf("%lu eq 1 %lu 24 ; increment == 4\n",
    (current_nid + 1174),  // nid of this line
    (current_nid + 1162)); // nid of increment
  printf("%lu ite 2 %lu 94 %lu ; unsigned-extended 4-byte input if increment == 4\n",
  ...
  printf("%lu eq 1 %lu 25 ; increment == 5\n",
    (current_nid + 1176),  // nid of this line
    (current_nid + 1162)); // nid of increment
  printf("%lu ite 2 %lu 95 %lu ; unsigned-extended 5-byte input if increment == 5\n",
  ...
  printf("%lu eq 1 %lu 26 ; increment == 6\n",
    (current_nid + 1178),  // nid of this line
    (current_nid + 1162)); // nid of increment
  printf("%lu ite 2 %lu 96 %lu ; unsigned-extended 6-byte input if increment == 6\n",
  ...
  printf("%lu eq 1 %lu 27 ; increment == 7\n",
    (current_nid + 1180),  // nid of this line
    (current_nid + 1162)); // nid of increment
  printf("%lu ite 2 %lu 97 %lu ; unsigned-extended 7-byte input if increment == 7\n",
  ...
  printf("%lu eq 1 %lu 28 ; increment == 8\n",
    (current_nid + 1182),  // nid of this line
    (current_nid + 1162)); // nid of increment
  printf("%lu ite 2 %lu 98 %lu ; 8-byte input if increment == 8\n",
  ...
  printf("%lu add 2 %lu %lu ; $a1 + $a0\n",
    (current_nid + 1184), // nid of this line
    (reg_nids + REG_A1),  // nid of current value of $a1 register
    (reg_nids + REG_A0)); // nid of current value of $a0 register
  printf("%lu write 3 %lu %lu %lu ; memory[$a1 + $a0] = input\n",
  ...
  printf("%lu ult 1 %lu %lu ; $a0 < $a2\n",
    (current_nid + 1190), // nid of this line
    (reg_nids + REG_A0),  // nid of current value of $a0 register
    (reg_nids + REG_A2)); // nid of current value of $a2 register
  printf("%lu and 1 %lu %lu ; $a7 == SYSCALL_READ and $a0 < $a2\n",
    (current_nid + 1191),  // nid of this line
    (current_nid + 11),    // nid of $a7 == SYSCALL_READ
    (current_nid + 1190)); // nid of $a0 < $a2
  printf("%lu and 1 60 %lu ; read ecall is in kernel mode and not done yet\n",
  ...
  printf("%lu ugt 1 %lu 20 ; increment > 0\n",
    (current_nid + 1193),  // nid of this line
    (current_nid + 1162)); // nid of increment
  printf("%lu and 1 %lu %lu ; read ecall is in kernel mode and not done yet and increment > 0\n",
  ...
  printf("%lu ite 3 %lu %lu %lu ; set memory[$a1 + $a0] = input if read ecall is in kernel mode and not done yet and increment > 0\n",
  ...
  printf("%lu add 2 %lu %lu ; $a0 + increment\n",
    (current_nid + 1196),  // nid of this line
    (reg_nids + REG_A0),   // nid of current value of $a0 register
    (current_nid + 1162)); // nid of increment
  printf("%lu ite 2 %lu %lu %lu ; set $a0 = $a0 + increment if read ecall is in kernel mode and not done yet\n",
  ...
  *(reg_flow_nids + REG_A0) = current_nid + 1197;
  ...
  printf("%lu ite 1 %lu 11 %lu ; stay in kernel mode if read ecall is in kernel mode and not done yet\n\n",
  ...
  // write ecall
  printf("%lu and 1 %lu %lu ; write ecall is active\n",
    (current_nid + 1200), // nid of this line
    ecall_flow_nid,       // nid of most recent update of ecall activation
    (current_nid + 12));  // nid of $a7 == SYSCALL_WRITE

  // if write ecall is active record $a1 register for checking address validity
  printf("%lu ite 2 %lu %lu %lu ; $a1 is start address of read buffer for checking address validity\n",
  ...
  printf("%lu ite 2 %lu %lu %lu ; $a1 + (($a2 - 1) / 8) * 8 if $a2 > 0, and $a1 otherwise\n",
    ...
    (reg_nids + REG_A1)); // nid of current value of $a1 register
  printf("%lu ite 2 %lu %lu %lu ; $a1 + (($a2 - 1) / 8) * 8 is end address of read buffer for checking address validity\n",
  ...
  printf("%lu ite 2 %lu %lu %lu ; set $a0 = $a2 if write ecall is active\n\n",
  ...
  *(reg_flow_nids + REG_A0) = current_nid + 1250;
  ...
  // openat ecall
  printf("%lu and 1 %lu %lu ; openat ecall is active\n",
    (current_nid + 1300), // nid of this line
    ecall_flow_nid,       // nid of most recent update of ecall activation
    (current_nid + 13));  // nid of $a7 == SYSCALL_OPENAT

  // if openat ecall is active record $a1 register for checking address validity
  printf("%lu ite 2 %lu %lu %lu ; $a1 is start address of filename for checking address validity\n",
  ...
  printf("%lu state 2 fd-bump\n", (current_nid + 1350));
  printf("%lu init 2 %lu 21 ; initial fd-bump is 1 (file descriptor bump pointer)\n",
  ...
  printf("%lu inc 2 %lu\n",
    ...
    (current_nid + 1350)); // nid of fd-bump
  printf("%lu ite 2 %lu %lu %lu ; fd-bump + 1 if openat ecall is active\n",
    (current_nid + 1353),  // nid of this line
    (current_nid + 1300),  // nid of openat ecall is active
    (current_nid + 1352),  // nid of fd-bump + 1
    (current_nid + 1350)); // nid of fd-bump
  printf("%lu next 2 %lu %lu ; increment fd-bump if openat ecall is active\n",
    (current_nid + 1354),  // nid of this line
    (current_nid + 1350),  // nid of fd-bump
    (current_nid + 1353)); // nid of fd-bump + 1
  printf("%lu ite 2 %lu %lu %lu ; set $a0 = fd-bump + 1 if openat ecall is active\n\n",
  ...
  *(reg_flow_nids + REG_A0) = current_nid + 1355;
  ...
  printf("%lu and 1 %lu %lu ; brk ecall is active\n",
    (current_nid + 1400), // nid of this line
    ecall_flow_nid,       // nid of most recent update of ecall activation
    (current_nid + 14));  // nid of $a7 == SYSCALL_BRK

  printf("%lu state 2 brk\n", (current_nid + 1450));
  printf("%lu init 2 %lu 31 ; initial program break\n",
  ...
  printf("%lu not 1 %lu ; $a0 is invalid\n",
    (current_nid + 1461),  // nid of this line
    (current_nid + 1457)); // nid of $a0 is valid
  printf("%lu and 1 %lu %lu ; brk ecall is active and $a0 is invalid\n",
    (current_nid + 1462),  // nid of this line
    (current_nid + 1400),  // nid of brk ecall is active
    (current_nid + 1461)); // nid of $a0 is invalid
  printf("%lu ite 2 %lu %lu %lu ; set $a0 = brk if brk ecall is active and $a0 is invalid\n",
  ...
  *(reg_flow_nids + REG_A0) = current_nid + 1463;
  ...
  if (check_block_access) {
    printf("%lu ite 2 %lu %lu %lu ; lower bound on $t1 = brk if brk ecall is active and $a0 is valid\n",
    ...
    *(reg_flow_nids + LO_FLOW + REG_T1) = current_nid + 1464;
    ...
    printf("%lu ite 2 %lu %lu %lu ; upper bound on $t1 = $a0 if brk ecall is active and $a0 is valid\n",
    ...
    *(reg_flow_nids + UP_FLOW + REG_T1) = current_nid + 1465;
    ...
    printf("%lu ite 2 %lu 30 %lu ; lower bound on $t1 = start of data segment if brk ecall is active and $a0 is invalid\n",
    ...
    *(reg_flow_nids + LO_FLOW + REG_T1) = current_nid + 1466;
    ...
    printf("%lu ite 2 %lu 50 %lu ; upper bound on $t1 = 4GB of memory addresses if brk ecall is active and $a0 is invalid\n",
...
void go_to_instruction(uint64_t from_instruction, uint64_t from_link, uint64_t from_address, uint64_t to_address, uint64_t condition_nid) {
  ...
  printf("%s: invalid instruction address %lX detected\n", selfie_name, to_address);
...
void model_divu() {
  if (rd != REG_ZR) {
    ...
    printf("%lu ite 2 %lu %lu %lu ; record %s for checking division by zero\n",
      current_nid,         // nid of this line
      pc_nid(pcs_nid, pc), // nid of pc flag of this instruction
      (reg_nids + rs2),    // nid of current value of $rs2 register
...
void model_remu() {
  if (rd != REG_ZR) {
    ...
    // if this instruction is active record $rs2 for checking if $rs2 == 0
    printf("%lu ite 2 %lu %lu %lu ; record %s for checking remainder by zero\n",
      current_nid,         // nid of this line
      pc_nid(pcs_nid, pc), // nid of pc flag of this instruction
      (reg_nids + rs2),    // nid of current value of $rs2 register
...
void model_jalr() {
  ...
  printf("%s: unsupported jalr at address %lX with estimated address %lX detected\n", selfie_name, pc, estimated_return);
...
void check_address_validity(uint64_t start, uint64_t flow_nid, uint64_t lo_flow_nid, uint64_t up_flow_nid) {
  ...
  printf("%lu bad %lu ; memory access below lower bound\n",
    current_nid + 1, // nid of this line
  ...
  printf("%lu ugte 1 %lu %lu\n",
    current_nid,  // nid of this line
    flow_nid,     // nid of address of most recent memory access
    up_flow_nid); // nid of current upper bound on memory addresses
  printf("%lu bad %lu ; memory access at or above upper bound\n",
    current_nid + 1, // nid of this line
    current_nid);      // nid of previous check
  ...
  printf("%lu and 2 %lu 27\n",
    current_nid, // nid of this line
    flow_nid);   // nid of address of most recent memory access
  printf("%lu neq 1 %lu 20\n",
    current_nid + 1, // nid of this line
    current_nid);      // nid of 3 LSBs of address of most recent memory access
  printf("%lu bad %lu ; word-unaligned memory access\n\n",
    current_nid + 2,  // nid of this line
...
void modeler() {
  ...
  printf("; BTOR2 %s generated by %s for\n", model_name, selfie_name);
  printf("; RISC-V code obtained from %s and\n; invoked as", binary_name);

  i = 0;

  while (i < number_of_remaining_arguments()) {
    printf(" %s", (char*) *(remaining_arguments() + i));
  ...
  while (i < NUMBEROFREGISTERS) {
    *(reg_flow_nids + i) = reg_nids + i;
    ...
    if (i == 0)
      ...
      printf("%lu state 2 %s ; register $%lu\n",
        *(reg_flow_nids + i), // nid of this line
        get_register_name(i),         // register name
    ...
    while (i < 3 * NUMBEROFREGISTERS) {
      *(reg_flow_nids + i) = reg_nids + i;
      ...
      if (i == LO_FLOW)
        ...
        printf("%lu state 2 ", *(reg_flow_nids + i));

        if (i < LO_FLOW + NUMBEROFREGISTERS)
          printf("lo-%s ; lower bound on $%lu\n",
  ...
  while (i < NUMBEROFREGISTERS) {
    if (i == 0)
      ...
      printf("%lu init 2 %lu 40 %s ; initial value from boot loader\n",
      ...
      printf("%lu init 2 %lu 20 %s ; initial value is 0\n",
        (reg_nids * 2 + i), // nid of this line
  ...
  if (check_block_access)
    while (i < 3 * NUMBEROFREGISTERS) {
      if (i % NUMBEROFREGISTERS == 0)
        ...
        printf("%lu init 2 %lu 30 %s ; initial value is start of data segment\n",
          reg_nids * 2 + i,                // nid of this line
          reg_nids + i,                    // nid of to-be-initialized register
          get_register_name(i % NUMBEROFREGISTERS)); // register name as comment
      else if (i < UP_FLOW + NUMBEROFREGISTERS)
        printf("%lu init 2 %lu 50 %s ; initial value is 4GB of memory addresses\n",
          reg_nids * 2 + i,                // nid of this line
          reg_nids + i,                    // nid of to-be-initialized register
          get_register_name(i % NUMBEROFREGISTERS)); // register name as comment
  ...
  printf("%lu state 3 memory ; data segment, heap, stack\n", current_nid);
  printf("%lu init 3 %lu %lu ; loading data segment and stack into memory\n",
    current_nid + 1, // nid of this line
  ...
  if (check_block_access) {
    ...
    printf("%lu init 3 %lu 30 ; initializing lower bounds to start of data segment\n",
      current_nid + 1, // nid of this line
    ...
    printf("%lu init 3 %lu 50 ; initializing upper bounds to 4GB of memory addresses\n",
      current_nid + 1, // nid of this line
  ...
  while (pc < code_start + code_size) {
    ...
    while (in_edge != (uint64_t*) 0) {
      ...
      if (from_instruction == BEQ) {
        ...
        printf("%lu and 1 %lu %lu ; beq %lu[%lX]",
          current_nid,                         // nid of this line
        ...
        if (jalr_address != 0) {
          ...
          printf("; exit ecall wrapper call or runaway jal %lu[%lX]", from_address, from_address);
          print_code_line_number_for_instruction(from_address, code_start);println();

          // this instruction may stay deactivated if there is no more in-edges
        }
      } else if (from_instruction == ECALL) {
        printf("%lu state 1 ; kernel-mode pc flag of ecall %lu[%lX]",
          current_nid,                         // nid of this line
          from_address, from_address); // address of instruction proceeding here
        print_code_line_number_for_instruction(from_address, code_start);println();

        printf("%lu init 1 %lu 10 ; ecall is initially inactive\n",
          current_nid + 1, // nid of this line
          current_nid);      // nid of kernel-mode pc flag of ecall

        printf("%lu ite 1 %lu 60 %lu ; activate ecall and keep active while in kernel mode\n",
          current_nid + 2,              // nid of this line
          current_nid,                    // nid of kernel-mode pc flag of ecall
          pc_nid(pcs_nid, from_address)); // nid of pc flag of instruction proceeding here

        printf("%lu next 1 %lu %lu ; keep ecall active while in kernel mode\n",
          current_nid + 3,  // nid of this line
          current_nid,        // nid of kernel-mode pc flag of ecall
          current_nid + 2); // nid of previous line

        printf("%lu and 1 %lu 62 ; ecall is active but not in kernel mode anymore\n",
        ...
        printf("%lu[%lX]", from_address, from_address);
        print_code_line_number_for_instruction(from_address, code_start);println();
    ...
    if (current_nid >= pc_nid(control_nid, pc) + 400) {
      ...
      printf("%s: too many in-edges at instruction address %lX detected\n", selfie_name, pc);
  ...
  while (i < NUMBEROFREGISTERS) {
    if (i == 0)
      ...
      printf("%lu next 2 %lu %lu %s ; register $%lu\n",

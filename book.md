...
Selfie is software that translates software including *itself* to code that can be executed by a computer. Selfie even includes software that can mimic the very computer that can execute the code of selfie. By now your mind might be spinning but you at least understand why selfie is called selfie.

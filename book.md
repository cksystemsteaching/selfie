...
Managing an ever expanding music library, similar to a photo library or just files containing documents, has become a problem for many in recent years. Even if you just stream your music, you still need to manage music you like and distinguish it from music you do not like. There is software that helps doing that but still with lots of room for improvement.

...
![NULL-terminated string of ASCII characters "science" contiguously stored at address 85 and above](string.png "String")
...
![A directory of a file "a" stored at address 85 and above and a file "b" stored at address 7 and above](directory.png "Directory")
...
![An image encoded and stored in memory in row-major](image.png "Image")
...
![A video encoded and stored in memory frame by frame](video.png "Video")
...
![Audio encoded with 8-bit bit depth and stored in memory sample by sample](audio.png "Audio")

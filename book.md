...
```
85 - 127 = 85 + (1000 - 127) - 1000 = 85 + (1000 - 1 - 127 + 1) - 1000 = 85 + (999 - 127 + 1) - 1000
```

```
85 + (999 - 127 + 1) - 1000 = 85 + (872 + 1) - 1000
```

```
85 + (872 + 1) - 1000 = 85 + 873 - 1000
```

```
85 - 127 = 85 + 873 - 1000 = 958 - 1000 = -42
```
...
—————————————>
 01010101 =  85
+10000000 = ones’ complement of 127
+       1
-10000000
—————————————>
 01010101 =  85
+10000001 = two’s complement of 127
-10000000
—————————————>
 11010110 = 85 + two’s complement of 127
-10000000
——————————————
 01010110 = -42
```
...
```
127 - 85 = 127 + (1000 - 85) - 1000 = 127 + (1000 - 1 - 85 + 1) - 1000 = 127 + (999 - 85 + 1) - 1000
```

```
127 + (999 - 85 + 1) - 1000 = 127 + (914 + 1) - 1000
```

```
127 + (914 + 1) - 1000 = 127 + 915 - 1000
```

```
127 + 915 - 1000 = 1042 - 1000 = 42
```

```
127 - 85 = 127 + 915 - 1000 = 42
```
...
—————————————>
 01111111 = 127
+10101010 = ones’ complement of 85
+       1
-10000000
—————————————>
 01111111 = 127
+10101011 = two’s complement of 85
-10000000
—————————————>
100101010 = 127 + two’s complement of 85
-10000000
——————————————
 00101010 = 42
```

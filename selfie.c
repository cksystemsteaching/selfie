...
uint64_t monster(uint64_t* to_context) {
  ...
  printf1((uint64_t*) "; smt-lib selfie-generated by %s\n", selfie_name);
  printf2((uint64_t*) "; for %s with %d execution depth\n\n", binary_name, (uint64_t*) max_execution_depth);

...
assignments: Set[Assignment] = {
    ...
    Assignment('print-your-name', 'General', '',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-print-your-name',
               check_print_your_name),
    Assignment('hex-literal', 'Compiler', 'hex-literal',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-hex-literal',
               check_hex_literal),
    Assignment('bitwise-shift-compilation', 'Compiler', 'bitwise-shift',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-bitwise-shift-compilation',
               check_bitwise_shift_compilation),
    Assignment('bitwise-shift-execution', 'Compiler', 'bitwise-shift',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-bitwise-shift-execution',
               check_bitwise_shift_execution),
    Assignment('bitwise-and-or-not', 'Compiler', 'bitwise-logic',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-bitwise-and-or-not',
               check_bitwise_and_or_not),
    Assignment('for-loop', 'Compiler', 'for-loop',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-for-loop',
               check_for_loop),
    Assignment('array', 'Compiler', 'array',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-array',
               check_array),
    Assignment('array-multidimensional', 'Compiler', 'array',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-array-multidimensional',
               check_multidimensional_array),
    Assignment('struct-declaration', 'Compiler', 'struct',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-struct-declaration',
               check_struct_declaration),
    Assignment('struct-execution', 'Compiler', 'struct',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/compiler-assignments.md#assignment-struct-execution',
               check_struct_execution),
    Assignment('assembler-parser', 'OS', 'assembler',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/systems-assignments.md#assignment-assembler-parser',
               check_assembler_parser),
    Assignment('self-assembler', 'OS', 'assembler',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/systems-assignments.md#assignment-self-assembler',
               check_self_assemblation),
    Assignment('processes', 'OS', 'processes',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/systems-assignments.md#assignment-processes',
               check_processes),
    Assignment('fork-wait', 'OS', 'fork-wait',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/systems-assignments.md#assignment-fork-wait',
               check_fork_and_wait),
    Assignment('fork-wait-exit', 'OS', 'fork-wait',
               'https://github.com/cksystemsteaching/selfie/blob/grader/grader/systems-assignments.md#assignment-fork-wait-exit',
               check_fork_wait_exit),
    Assignment('lock', 'OS', 'lock',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/systems-assignments.md#assignment-lock',
               check_lock),
    Assignment('threads', 'OS', 'threads',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/systems-assignments.md#assignment-threads',
               check_threads),
    Assignment('treiber-stack', 'OS', 'treiber-stack',
               'https://github.com/cksystemsteaching/selfie/blob/master/grader/systems-assignments.md#assignment-treiber-stack',
               check_treiber_stack)
}
